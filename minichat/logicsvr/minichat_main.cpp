...
#include <unistd.h>
#include <signal.h>
#include "phxrpc_minichat_dispatcher.h"
...
void HttpDispatch( const phxrpc::HttpRequest & request, phxrpc::HttpResponse * response, phxrpc::DispatcherArgs_t * args ) {
    ...
    MiniChatServiceImpl service( service_args );
    MiniChatDispatcher dispatcher( service, args );

    phxrpc::HttpDispatcher<MiniChatDispatcher> http_dispatcher(
            dispatcher, MiniChatDispatcher::GetURIFuncMap() );
...
int main( int argc, char * argv[] ) {
    ...
    openlog( "minichat_main", LOG_CONS | LOG_PID, 0 );
