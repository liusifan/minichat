...
#include <unistd.h>
#include <signal.h>
#include "phxrpc_profile_dispatcher.h"
...
void HttpDispatch( const phxrpc::HttpRequest & request, phxrpc::HttpResponse * response, phxrpc::DispatcherArgs_t * args ) {
    ...
    ProfileServiceImpl service( * service_args );
    ProfileDispatcher dispatcher( service, args );

    phxrpc::HttpDispatcher<ProfileDispatcher> http_dispatcher(
            dispatcher, ProfileDispatcher::GetURIFuncMap() );
