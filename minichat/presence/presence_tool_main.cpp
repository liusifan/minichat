...
void showUsage( const char * program )
{
    ...
    PresenceTool::Name2Func_t * name2func = PresenceTool::GetName2Func();

    for( int i = 0; ; i++ ) {
        PresenceTool::Name2Func_t * iter = &( name2func[i] );
...
int main( int argc, char * argv[] )
{
    ...
    if( NULL != config ) PresenceClient::Init( config );

    PresenceTool::Name2Func_t * target = NULL;
    ...
    PresenceTool::ToolFunc_t targefunc = target->func;

    PresenceToolImpl tool;
