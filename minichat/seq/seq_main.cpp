...
#include <unistd.h>
#include <signal.h>
#include "phxrpc_seq_dispatcher.h"
...
void HttpDispatch( const phxrpc::HttpRequest & request, phxrpc::HttpResponse * response, phxrpc::DispatcherArgs_t * args ) {
    ...
    SeqServiceImpl service( * service_args );
    SeqDispatcher dispatcher( service, args );

    phxrpc::HttpDispatcher<SeqDispatcher> http_dispatcher(
            dispatcher, SeqDispatcher::GetURIFuncMap() );
