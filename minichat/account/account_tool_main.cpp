...
void showUsage( const char * program )
{
    ...
    AccountTool::Name2Func_t * name2func = AccountTool::GetName2Func();

    for( int i = 0; ; i++ ) {
        AccountTool::Name2Func_t * iter = &( name2func[i] );
...
int main( int argc, char * argv[] )
{
    ...
    if( NULL != config ) AccountClient::Init( config );

    AccountTool::Name2Func_t * target = NULL;
