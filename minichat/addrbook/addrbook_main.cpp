...
#include <unistd.h>
#include <signal.h>
#include "phxrpc_addrbook_dispatcher.h"
...
void HttpDispatch( const phxrpc::HttpRequest & request, phxrpc::HttpResponse * response, phxrpc::DispatcherArgs_t * args ) {
    ...
    AddrbookServiceImpl service( * service_args );
    AddrbookDispatcher dispatcher( service, args );

    phxrpc::HttpDispatcher<AddrbookDispatcher> http_dispatcher(
            dispatcher, AddrbookDispatcher::GetURIFuncMap() );
