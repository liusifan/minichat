...
ACCOUNT_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
...
ADDRBOOK_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(MINICHAT_ROOT)/minichat/common -lcommon \
...
CERT_LDFLAGS :=  $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(PHXRPC_ROOT)/lib -lphxrpc \
...
LOGIC_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
...
MSGBOX_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(MINICHAT_ROOT)/minichat/common -lcommon \
	-L$(MINICHAT_ROOT)/minichat/seq -lseq_client \
	-L$(PHXRPC_ROOT)/lib -lphxrpc \
	$(LDFLAGS) \
...
PRESENCE_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(MINICHAT_ROOT)/minichat/common -lcommon \
	-L$(PHXRPC_ROOT)/lib -lphxrpc \
	$(LDFLAGS) \
	$(REDIS_CLIENT_LIBRARY)
...
PROFILE_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(MINICHAT_ROOT)/minichat/common -lcommon \
	-L$(PHXRPC_ROOT)/lib -lphxrpc \
	$(LDFLAGS) \
	$(REDIS_CLIENT_LIBRARY)
...
SEQ_LDFLAGS := $(PLUGIN_ELPP_LDFLAGS) $(PLUGIN_REDIS_CONFIG_LOADER_LDFLAGS) \
	-L$(MINICHAT_ROOT)/minichat/common -lcommon \
	-L$(PHXRPC_ROOT)/lib -lphxrpc \
	$(LDFLAGS) \
	$(REDIS_CLIENT_LIBRARY)
